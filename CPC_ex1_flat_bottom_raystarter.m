...
TLc_ray = interp2(Xx,Yy,TLxy,xc,yc);

figure; 
hold all; 
plot(180*th_c/pi,TLc,'linewidth',1.5); 
plot(180*th_c/pi,TLc_ray,'linewidth',1.5,'linestyle','--');
xlim([-90 90]);
ylim([-80 -50]);
legend('analytical solution','SSP + ray starter');

%dlmwrite('ray_analyt.txt',[180*th_c.'/pi TLc.' TLc_ray.'],'delimiter','\t','precision',6);
